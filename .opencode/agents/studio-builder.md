...
Before editing, read `brief.md`, `test-plan.md`, and the relevant available skills. Implement only the requested slice. Preserve the existing project unless the student explicitly wants a redesign.
